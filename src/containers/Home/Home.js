          ...
          <div className="container">
            ...
            <p className={styles.humility}>
              Created and maintained by <a
                ...
                target="_blank" rel="noopener noreferrer">@erikras</a>.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <ul>
            ...
            <li><a
              ...
              rel="noopener noreferrer" target="_blank">React</a></li>
            <li><a
              href="https://github.com/rackt/react-router"
              rel="noopener noreferrer" target="_blank">React Router</a></li>
            <li><a
              href="http://expressjs.com"
              rel="noopener noreferrer" target="_blank">Express</a></li>
            <li><a
              href="http://babeljs.io"
              rel="noopener noreferrer" target="_blank">Babel</a> for ES6 and ES7 magic</li>
            <li><a
              href="http://webpack.github.io"
              rel="noopener noreferrer" target="_blank">Webpack</a> for bundling</li>
            <li>
              <a
                href="http://webpack.github.io/docs/webpack-dev-middleware.html"
                rel="noopener noreferrer" target="_blank">Webpack Dev Middleware</a>
            </li>
            <li><a
              href="https://github.com/glenjamin/webpack-hot-middleware"
              rel="noopener noreferrer" target="_blank">Webpack Hot Middleware</a>
            </li>
            <li><a
              href="https://github.com/rackt/redux"
              rel="noopener noreferrer" target="_blank">Redux</a>'s futuristic <a
                href="https://facebook.github.io/react/blog/2014/05/06/flux.html"
                rel="noopener noreferrer" target="_blank">Flux</a> implementation
            </li>
            <li><a
              href="https://github.com/gaearon/redux-devtools"
              rel="noopener noreferrer" target="_blank">Redux Dev Tools</a> for next
              generation DX (developer experience).
              Watch <a
                href="https://www.youtube.com/watch?v=xsSnOQynTHs"
                rel="noopener noreferrer" target="_blank">Dan Abramov's talk</a>.
            </li>
            <li><a
              href="https://github.com/rackt/redux-router"
              rel="noopener noreferrer" target="_blank">Redux Router</a> Keep
              your router state in your Redux store
            </li>
            <li><a
              href="http://eslint.org"
              rel="noopener noreferrer" target="_blank">ESLint</a>
              to maintain a consistent code style</li>
            <li><a
              href="https://github.com/erikras/redux-form"
              rel="noopener noreferrer" target="_blank">redux-form</a>
              to manage form state in Redux
            </li>
            <li><a
              href="https://github.com/erikras/multireducer"
              rel="noopener noreferrer" target="_blank">multireducer</a> combine several
              identical reducer states into one key-based reducer
            </li>
            <li><a
              href="https://github.com/webpack/style-loader"
              rel="noopener noreferrer" target="_blank">style-loader</a> and <a
                href="https://github.com/jtangelder/sass-loader"
                rel="noopener noreferrer" target="_blank">sass-loader</a> to allow import of
              stylesheets
            </li>
            <li><a
              href="https://github.com/shakacode/bootstrap-sass-loader"
              rel="noopener noreferrer" target="_blank">bootstrap-sass-loader</a>
              and <a
                href="https://github.com/gowravshekar/font-awesome-webpack"
                rel="noopener noreferrer" target="_blank">font-awesome-webpack</a> to
          ...
          <dl>
            ...
            <dt>Forms</dt>
            <dd>
              The <Link to="/survey">Survey page</Link> uses the still-experimental <a
                href="https://github.com/erikras/redux-form"
                rel="noopener noreferrer" target="_blank">redux-form</a> to
